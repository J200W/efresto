...
<body>
    ...
    <div class="submit-button">
        <input type="button" name="previousPage" value="Previous Page" class="btn btn-primary"
            onClick="document.location.href='restaurant.php?id=<?php echo $id; ?>'">
    </div>
</body>
...
<footer>
    <div class="logo">
        ...
        <img src="<?php echo 'data:image;base64,' . $efresto_logo; ?>" alt="Efresto Logo" width="150px" height="150px">
