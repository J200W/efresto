...
if ($_SESSION["status"] != "r" && $_SESSION["status"] != "a") {
    header("location: login.php");
    exit;
}
$uid = $_SESSION["user_id"];
$sql = "SELECT * FROM restaurant where user_id = '$uid'";
...
<body>
    ...
    <h1 class="titlePage">My Restaurants</h1>
    <hr>
    <div class="modify">
        <input type="button" name="createRestaurant" value="Create Restaurant" class="btn btn-primary"
            onClick="document.location.href='createRestaurant.php'">
    </div>
